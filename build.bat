copy /y scripts\appveyor\qmake.bat C:\Qt\6.7.0\msvc2019_arm64\bin
copy /y scripts\appveyor\qtpaths.bat C:\Qt\6.7.0\msvc2019_arm64\bin
copy /y scripts\appveyor\target_qt.conf C:\Qt\6.7.0\msvc2019_arm64\bin
set OLDPATH=%PATH%
